...
const services = [
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un agente de WhatsApp con IA?', a: 'Depende de la complejidad del flujo de conversación, pero proyectos de este tipo suelen estar entre USD 800 y USD 3.000. Te damos un presupuesto fijo antes de empezar.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un dashboard automatizado?', a: 'Un dashboard en Google Sheets suele arrancar en USD 300–800. Una app web dedicada con base de datos propia va de USD 1.000 en adelante, según el alcance.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un sistema de monitoreo?', a: 'Depende de cuántos procesos o agentes monitorea y la complejidad de los umbrales, pero suele estar entre USD 800 y USD 2.500.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un CRM a medida?', a: 'Un CRM completo con roles, base de datos y panel suele estar entre USD 1.000 y USD 3.000, según la cantidad de etapas e integraciones.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta automatizar las auditorías de calidad?', a: 'Depende de la complejidad de los criterios de evaluación, pero proyectos similares están entre USD 800 y USD 2.000.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un sistema de control de asistencia?', a: 'Un sistema básico de registro y turnos arranca en USD 500. Con reglas de rotación y alertas automáticas, entre USD 800 y USD 1.800.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta una extensión de Chrome a medida?', a: 'Proyectos de este tipo suelen estar entre USD 400 y USD 1.200, según cuántos flujos automatiza y la complejidad del sitio objetivo.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta automatizar un proceso con Python?', a: 'Los scripts simples arrancan desde USD 300. Automatizaciones más complejas, con múltiples sistemas conectados, van de USD 800 a USD 2.000.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta integrar Google Workspace?', a: 'Automatizaciones simples con Apps Script arrancan en USD 300. Integraciones más completas con múltiples servicios van de USD 600 a USD 1.500.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un sistema de scraping?', a: 'Depende de la complejidad del sitio y la frecuencia de extracción, pero suele estar entre USD 400 y USD 1.500.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un chatbot de atención al cliente?', a: 'Depende del alcance y los canales, pero proyectos de este tipo suelen estar entre USD 700 y USD 2.500.' },
    ],
  ...
  },
  {
    ...
    faq: [
      ...
      { q: '¿Cuánto cuesta un sistema web a medida?', a: 'Sistemas completos con login, roles y API suelen estar entre USD 1.500 y USD 4.000, según el alcance funcional.' },
    ],
